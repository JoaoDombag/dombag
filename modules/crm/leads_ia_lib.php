...
if (!defined('LEADS_PRESETS')) {
    define('LEADS_PRESETS', [
        'nutricao_animal' => [
            ...
            'descricao'           => 'Rações, premix, suplementos e ingredientes para alimentação animal.',
            ...
            'cidades_raw'         => '',
            'termos_positivos_raw'=> 'indústria, fabricante, fábrica de ração, nutrição animal, pet food, premix, suplementos animais, ingredientes',
        ...
        'fertilizantes' => [
            ...
            'descricao'           => 'Misturadoras, adubos, química agrícola e biossoluções.',
            ...
            'produto_foco'        => 'big bag',
            'porte'               => 'médio e grande',
            'cidades_raw'         => '',
            'termos_positivos_raw'=> 'fertilizantes, insumos agrícolas, adubos, mistura, química agrícola, biossoluções, granulado, mineral',
        ...
        'usinas_bioenergia' => [
            ...
            'descricao'           => 'Usinas de açúcar e álcool, etanol, biomassa e bioenergia.',
            'segmento'            => 'usinas e bioenergia',
            'subsegmentos'        => 'usina de açúcar e álcool, etanol, destilaria, bioenergia, sucroalcooleira',
            'produto_foco'        => 'big bag e sacaria de ráfia',
            'porte'               => 'grande',
            'cidades_raw'         => '',
            'termos_positivos_raw'=> 'usina, açúcar, álcool, etanol, bioenergia, biomassa, sucroenergético, destilaria',
        ...
        'sementes_cerealistas' => [
            ...
            'descricao'           => 'Beneficiadoras de sementes, cerealistas, armazéns e silos.',
            ...
            'porte'               => 'médio e grande',
            'cidades_raw'         => '',
            'termos_positivos_raw'=> 'sementes, cerealista, armazenagem, grãos, amendoim, beneficiamento, silos, armazéns',
        ...
        'mineracao' => [
            ...
            'descricao'           => 'Mineradoras, moagem de minerais, calcário e carvão.',
            ...
            'porte'               => 'médio e grande',
            'cidades_raw'         => '',
            'termos_positivos_raw'=> 'mineração, mineral, calcário, minério, carvão, moagem, minerais industriais',
